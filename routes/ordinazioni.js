...
//let query = "SELECT idordine FROM angelina.an_dettaglioordine WHERE idDettaglioOrdine = '" + schedaId + "' ";
...
//res.idOrdine=idOrdine;
//module.exports.viewDettaglioOrdinazione(req, res);
